...
export const playerSchema = z.object({
  ...
  prestigeamount: z.union([decimalSchema, decimalStringSchema.transform(Number)]),
  transcendamount: z.union([decimalSchema, decimalStringSchema.transform(Number)]).default(() =>
    blankSave.transcendamount
  ),
  reincarnationamount: z.union([decimalSchema, decimalStringSchema.transform(Number)]),
